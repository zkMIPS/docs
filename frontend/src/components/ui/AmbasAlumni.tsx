  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground leading-relaxed text-gray-600 mb-4">
        ...
        <div className="flex flex-grow flex-row items-end justify-between">
          <div>
            ...
            <DialogSubtitle className="text-zinc-700 dark:text-zinc-400">
              Explore post-program opportunities
            </DialogSubtitle>
          </div>
          <button
            type="button"
          ...
          <div className="p-6">
            ...
            >
              <p className="text-muted-foreground leading-relaxed text-gray-600">
                Stay connected with ZKM beyond the ambassador program. Alumni
                gain access to exclusive events, priority for new initiatives,
                and recognition for their past contributions.
              </p>
