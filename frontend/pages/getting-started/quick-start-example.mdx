...
This produces an ELF binary in `prover/examples/sha2-rust/target/mips-unknown-linux-musl/debug/sha2-bench`

```sh copy
export ELF_PATH=$BASEDIR/prover/examples/sha2-rust/target/mips-unknown-linux-musl/debug/sha2-rust
```
