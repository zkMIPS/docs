...
export function AmbasCommunity() {
  return (
    <Dialog
      transition={{
        type: 'spring',
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground mb-6 text-gray-600">
          Connect with fellow ambassadors, share experiences, and collaborate on initiatives in our community hub.
        </p>
          ...
          <div className="p-6">
            ...
            >
              <p className="text-muted-foreground leading-relaxed text-gray-600">
                Our community hub is the central gathering place for ZKM ambassadors to:
              </p>
              <ul className="mt-4 space-y-4">
                <li className="flex items-start gap-3">
                  <Users className="mt-1 h-5 w-5 text-orange-zkm" />
                  <div>
                    <h3 className="font-semibold">Connect & Collaborate</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Network with other ambassadors and share ideas
                    </p>
                  </div>
                </li>
