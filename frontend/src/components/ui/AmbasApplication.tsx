  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground mb-4 leading-relaxed text-gray-600">
        ...
        <div className="flex flex-grow flex-row items-end justify-between">
          <div>
            ...
            <DialogSubtitle className="text-zinc-700 dark:text-zinc-400">
              Learn how to join our ambassador program
            </DialogSubtitle>
          </div>
          <button
            type="button"
          ...
          <div className="p-6">
            ...
            >
              <p className="text-muted-foreground leading-relaxed text-gray-600">
                Interested candidates should apply with their relevant
                experience and motivations. Selected ambassadors will complete a
                brief onboarding to understand ZKM&apos;s vision and goals.
              </p>
