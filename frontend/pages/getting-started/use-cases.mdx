---
title: Use Cases
description: A set of examples of what can be built using ZKM
---
...
<Image
  src="/assets/use-cases/hybrid-rollup.png"
  alt="Hybrid Rollup"
  width={500}
  height={500}
  style={{
...
<Image
  src="/assets/use-cases/entangled-rollup.png"
  alt="Entangled Rollup"
  width={500}
  height={500}
  style={{
    display: 'block',
...
<Image
  src="/assets/use-cases/universal-l2.png"
  alt="Universal L2"
  width={500}
  height={500}
  style={{
...
<Image width="1080" height="1080" src="/assets/step8.png" alt="Step 8" />
